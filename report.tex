...
% TODO Add your title
\title{High Level Control of an MAV through Marker-Based Visual Commands }
%\subtitle{bla bla bla}

% TODO Add name of the authors
\studentA{Dimitris Gryparis}


% TODO Add name of the supervisors
\supervisionA{Helen Oleynikova}
...
\cleardoublepage
\input{chapters/SystemDescription} %system description
\cleardoublepage
\input{chapters/SystemSetup}
\cleardoublepage
\input{chapters/ExperimentalResults}
\cleardoublepage
\input{chapters/cocnlusions}
\cleardoublepage
